...
// $time = time();
// foreach($raw->daily->data as $k=>$d)
// {
// 	print_r (date('d/m/Y h:m',$d->time).PHP_EOL);

// 	if ($d->time>$time)
// 	{
// 		$data = isset($raw->daily->data[$k-1]) ? $raw->daily->data[$k-1] : $d;
// 		break;
// 	}
// }
    ...
    <body class="">
		...
		<footer>
			<div class="left">
				...
				<span>Screenly Apps - Weather Forecast. © <?php echo date('Y');?> WireLoad, Inc.</span>
			</div>
